...
export SUBJECT=/C=/ST=/L=/O=/CN=cliente
...
openssl pkcs12 -name kobra -export -out ${PKCS12_FILE} -inkey ${PRIVATE_KEY_FILE} -in ${CERTIFICATE_FILE} -password pass:${KEY_PASSWORD}
