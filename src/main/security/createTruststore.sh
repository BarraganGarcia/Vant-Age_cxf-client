#!/bin/sh
export THIRD_PART_CERTIFICATE=cdc_certificate.pem
export TRUSTSTORE_FILE=truststore.jks
export TRUSTSTORE_PASSWORD=
export KEY_PASSWORD=
export CERT_ALIAS=cliente
...
keytool -import -file ${THIRD_PART_CERTIFICATE} -keystore ${TRUSTSTORE_FILE} -storepass ${TRUSTSTORE_PASSWORD} -noprompt -alias ${CERT_ALIAS}
#Lista el contenido del truststore.
keytool -list -keystore ${TRUSTSTORE_FILE} -storepass ${TRUSTSTORE_PASSWORD}
